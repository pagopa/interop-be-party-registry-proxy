...
import it.pagopa.pdnd.interop.uservice.partyregistryproxy.model.Problem
    ...
    trait InstitutionApiService {
          def getCategories200(responseCategories: Categories)(implicit toEntityMarshallerCategories: ToEntityMarshaller[Categories]): Route =
            complete((200, responseCategories))
  def getCategories404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
   ...
   * Code: 404, Message: Categories not found, DataType: Problem
        */
        def getCategories()
            (implicit toEntityMarshallerCategories: ToEntityMarshaller[Categories], toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route

          def getInstitutionById200(responseInstitution: Institution)(implicit toEntityMarshallerInstitution: ToEntityMarshaller[Institution]): Route =
            complete((200, responseInstitution))
  def getInstitutionById400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
  def getInstitutionById404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((404, responseProblem))
        /**
   ...
   * Code: 404, Message: Institution not found, DataType: Problem
        */
        def getInstitutionById(institutionId: String)
            (implicit toEntityMarshallerInstitution: ToEntityMarshaller[Institution], toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route

          def searchInstitution200(responseInstitutions: Institutions)(implicit toEntityMarshallerInstitutions: ToEntityMarshaller[Institutions]): Route =
            complete((200, responseInstitutions))
  def searchInstitution400(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((400, responseProblem))
  def searchInstitution404(responseProblem: Problem)(implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem]): Route =
            complete((404, responseProblem))
        /**
   ...
   * Code: 404, Message: Institution not found, DataType: Problem
        */
        def searchInstitution(search: String, page: Int, limit: Int)
            (implicit toEntityMarshallerProblem: ToEntityMarshaller[Problem], toEntityMarshallerInstitutions: ToEntityMarshaller[Institutions]): Route
