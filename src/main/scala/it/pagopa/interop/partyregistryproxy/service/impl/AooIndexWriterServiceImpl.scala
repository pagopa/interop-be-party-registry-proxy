...
case object AooIndexWriterServiceImpl extends IndexWriterService[Institution] {

  override val dir: FSDirectory        = FSDirectory.open(Paths.get(ApplicationConfiguration.aooIndexDir))
