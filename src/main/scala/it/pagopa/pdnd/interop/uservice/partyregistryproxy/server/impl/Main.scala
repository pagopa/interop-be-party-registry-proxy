...
object Main extends App with CorsSupport {
  ...
  locally {
    val _ = OpenDataLoader.loadOpenData(openDataService, institutionsSearchService, categoriesSearchService)
  ...
  val controller = new Controller(healthApi, institutionApi, loaderApi)
